...
public class JWTService {
    ...
    public String generateToken(String username, Role role) {
        ...
        Date expirationDate = new Date(currentTimeMillis + 60 * 60 * 1000); // 1 hour expiration
        ...
        String token = Jwts.builder()
                ...
                .signWith(getKey())
                .compact();
        logger.info("JWTService.generateToken(username, role) => username: {}, token: {}, expiration: {}", username, token, expirationDate);
        return String.format("Token: %s, Username: %s, Role: %s, Expiration: %s", token, username, role.name(), expirationDate);
    }
